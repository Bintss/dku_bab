...
// ⚠️ Mock Data (UserPage와 동일한 구조여야 합니다)
...
export default function RestaurantDetailPage() {
    ...
    useEffect(() => {
        // [프론트엔드 테스트용 로직] Mock Data에서 ID에 맞는 식당을 찾습니다.
        const mockFetch = () => {
    ...
    if (!restaurant) return <div style={{ textAlign: 'center', padding: '50px' }}>식당 정보를 찾을 수 없습니다. (ID: {id})</div>;
